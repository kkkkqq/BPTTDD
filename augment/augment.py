...
class DiffAug():
    ...
    def flip_fn(self, x, batch=True):
        ...
        if batch:
            ...
            randf = torch.from_numpy(np.random.uniform(0, 1, (x.size(0), 1, 1, 1))).to(x.device)
    ...
    def brightness_fn(self, x, batch=True):
        ...
        if batch:
            ...
            randb = torch.from_numpy(np.random.uniform(0, 1, (x.size(0), 1, 1, 1))).to(dtype=x.dtype, device=x.device)
    ...
    def saturation_fn(self, x, batch=True):
        ...
        if batch:
            ...
            rands = torch.from_numpy(np.random.uniform(0, 1, (x.size(0), 1, 1, 1))).to(dtype=x.dtype, device=x.device)
    ...
    def contrast_fn(self, x, batch=True):
        ...
        if batch:
            ...
            randc = torch.from_numpy(np.random.uniform(0, 1, (x.size(0), 1, 1, 1))).to(dtype=x.dtype, device=x.device)
    ...
    def translate_fn(self, x, batch=True):
        ...
        if batch:
            ...
            translation_y = torch.from_numpy(np.random.randint(-shift_y, shift_y+1, (x.size(0), 1, 1))).to(x.device)
    ...
    def crop_fn(self, x, batch=True):
        ...
        if batch:
            ...
            translation_x = torch.from_numpy(np.random.randint(-shift_x, shift_x+1, (x.size(0), 1, 1))).to(x.device)
    ...
    def cutout_fn(self, x, batch=True):
        ...
        if batch:
            ...
            offset_x = torch.from_numpy(np.random.randint(0,
            ...
            offset_y = torch.from_numpy(np.random.randint(0,
